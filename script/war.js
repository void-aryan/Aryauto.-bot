...
module.exports.run = async function({ api, args, event, admin }) {
        ...
        a("backstabber ka pala gago ka putanginamo ka walang iyakan ah bwakananginaka eh,ginagalit mo pa ako kapal");
        setTimeout(() => {
                a({
                        body:
        ...
        setTimeout(() => {
                a({ body: "sa isip ko palang kinantot na kita bobo" });
        }, 145000);
        setTimeout(() => {
